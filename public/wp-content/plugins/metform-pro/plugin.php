...
final class Plugin {
	...
	public function add_pro_integration_asset(){
		...
		// Enqueue author search script for searchable author select

		if($screen->id == 'edit-metform-form' || $screen->id == 'metform-form') {
			
			wp_enqueue_script('metform-author-search', $this->public_url() . 'assets/js/author-search.js', ['jquery'], $this->version(), true);
			wp_localize_script('metform-author-search', 'mf_author_search', [
