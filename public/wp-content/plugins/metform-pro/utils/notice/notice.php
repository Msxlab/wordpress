...
class Notice{
    ...
    public static function dismiss_ajax_call() {
        ...
        if (empty($_POST['nonce']) || !wp_verify_nonce(sanitize_text_field(wp_unslash($_POST['nonce'])), 'wpmet-dismiss-notices')) {
                    ...
                    $( '.wpmet-notice.is-dismissible' ).on( 'click', '.notice-dismiss', function() {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                nonce 			: '" . esc_js(wp_create_nonce('wpmet-dismiss-notices')) . "'
                            },
                        });
                    });
                });
