...
class Facebook_Feed_Carousel extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_description',
			[ 
				'label' => esc_html__( 'Description', 'bdthemes-element-pack' ) . BDTEP_UC,
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [ 
					'show_desc' => 'yes'
				]
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-facebook-feed-carousel .bdt-social-button' => 'gap: {{SIZE}}{{UNIT}};',
				],
				'condition' => [ 
					'show_like_comments' => 'yes',
					'show_like' => 'yes',
			...
			<div class="swiper-slide bdt-item">
				<div class="bdt-content">
					...
					<div class="bdt-img-content">
						<?php if ( 'yes' === $settings['show_read_more'] || 'yes' === $settings['show_share'] ) : ?>
