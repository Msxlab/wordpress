...
class AnimatedHeading extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'spilt_anim_yoyo',
			[ 
				'label'   => esc_html__( 'Yoyo Effect', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'no',
                'return_value' => 'yes',
				'condition' => [
					'spilt_anim_repeat' => 'yes',
				],
			]
		);
					...
					'animated-heading' => [ 
						'data-settings' => [ 
							wp_json_encode( [ 
								...
								'anim_yoyo'             => ( isset( $settings['spilt_anim_yoyo'] ) && 'yes' === $settings['spilt_anim_yoyo'] ) ? true : false,
							] )
						]
					]
				]
