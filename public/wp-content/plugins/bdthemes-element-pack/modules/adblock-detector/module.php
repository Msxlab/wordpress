...
class Module extends Element_Pack_Module_Base {
	...
	public function header_script_render() {
		...
		?>
		<link rel="stylesheet" href="<?php echo esc_url(BDTEP_ASSETS_URL); ?>vendor/css/abdetector.style.css">
		<?php
	}
	...
	public function footer_script_render() {
		...
		?>
		<script src="<?php echo esc_url(BDTEP_ASSETS_URL); ?>vendor/js/abdetector.script.min.js"></script>
