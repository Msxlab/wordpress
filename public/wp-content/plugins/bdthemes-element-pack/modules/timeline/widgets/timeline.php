...
class Timeline extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'date_always_visible_at_top',
			[ 
				'label'     => esc_html__( 'Date Always Visible at Top', 'bdthemes-element-pack' ) . BDTEP_NC,
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[ 
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [ 
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span i:hover' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bdt-timeline .bdt-timeline-icon span svg:hover' => 'fill: {{VALUE}};',
				],
			]
		);
	...
	public function render_meta( $align, $item = [] ) {
		...
		if ( 'post' == $settings['timeline_source'] ) { ?>
			...
			<?php if ( $settings['date_always_visible_at_top'] == '' ) {
			...
			if ( $settings['date_always_visible_at_top'] == '' ) : ?>
			<ul class="bdt-timeline-meta bdt-subnav bdt-flex-middle">
				<li>
	...
	public function render_item( $item_parallax, $align, $item = [] ) {
		...
		<div class="bdt-timeline-item-main elementor-repeater-item-<?php echo isset( $item['_id'] ) ? esc_attr( $item['_id'] ) : ''; ?>" <?php echo wp_kses_post( $item_parallax ); ?>>
			...
			<?php endif; ?>
			<?php if ( $align == 'center' ) : ?>
				<span class="bdt-timeline-arrow bdt-visible@m"></span>
			<?php endif; ?>
	...
	public function render_post_date( $align = 'left', $item = [] ) {
		...
		?>
		<div class="bdt-timeline-date bdt-timeline-top-date bdt-flex bdt-margin-bottom bdt-position-relative" <?php echo esc_attr( $date_parallax ); ?>>

			<span class="bdt-timeline-arrow"></span>

			<span class="bdt-position-z-index bdt-position-relative">
				<?php echo esc_html( $timeline_date ); ?>
			</span>
		</div>
		<?php
						...
						<div
							...
							<div class="bdt-timeline-item-main-wrapper">
								...
								<div class="bdt-timeline-item-main-container">
									...
									<?php if ( $settings['date_always_visible_at_top'] == 'yes' ) : ?>
									<?php $this->render_post_date( $align, ''); ?>
									<?php endif; ?>
					...
					<div
						...
						<div class="bdt-timeline-item-main-wrapper">
							...
							<div class="bdt-timeline-item-main-container">
								...
								<?php if ( $settings['date_always_visible_at_top'] == 'yes' ) : ?>
									<?php $this->render_post_date($align, $item); ?>
								<?php endif; ?>
