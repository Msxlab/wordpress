...
= 9.0.12 [12th January 2026] =

= Added =

* Shadow mode show on mobile option added in marquee widget

= Fixed =

* Modal/Popup content scrolling issue fixed ( Thanks to Daz )
* CSRF vulnerability fixed in Simple Contact Form widget
* Masonry issue fixed in testimonial grid widget
* Biggopti cache image URL issue fixed
* Mask color shape not found issue fixed
* Template Library import issue fixed ( Thanks to Michel Duineveld )
* WPML compatibility issue fixed
* Hash location issue fixed in post gallery widget
* Arrow icon position issue fixed in vertical menu widget

= 9.0.11 [24th December 2025] =

= Updated =

* System improved

= 9.0.10 [24th December 2025] =

= Fixed =

* Items link condition issue fixed in marker widget
* Social icon issue fixed in member widget
* Elementor editor hanging issue fixed in Background Parallax extension
* Performance optimized by skipping parallax effects in editor mode (frontend only)
* Image issue fixed in Facebook Feed and Facebook Feed Carousel widgets

= 9.0.9 [21st December 2025] =

= Added =

* Date Always Visible at Top feature added for custom content in Timeline widget

= 9.0.8 [17th December 2025] =

= Added =

* ACF all field type support added to Table widget ( Thanks to Rezu )
* Date Always Visible at Top feature added in Timeline widget

= Fixed =

* Icon position issue fixed in lightbox widget
* Clickable area issue fixed for Vertical Menu widget ( Thanks to Charles )

= 9.0.7 [4th December 2025] =

= Fixed =

* Footer template conflict with the Hello theme has been fixed ( Thanks to Mads Speitzer )
* Avatar not showing issue fixed in post info widget

= 9.0.6 [3rd December 2025] =

= Added =

* Made compatible with WordPress version 6.9
* Added new control for controlling animation in the changelog widget
* Added support for configuring the Contact Number field as optional ( Thanks to Marc Landman )

= Fixed =

* Responsive issue fixed in timeline widget
* Elementor Template searching issue fixed in widget settings

= 9.0.5 [26th November 2025] =

= Added =

* Always Active All Items control added in accordion & FAQ widgets

= Fixed =

* Proper condition applied for text, read more and like/comments controls in the facebook feed and facebook feed carousel widgets
* List spacing issue fixed in changelog widget
* CSV file type deprecated issue fixed in table widget

= 9.0.4 [20th November 2025] =

= Added =

* ACF support added for Table widget ( Thanks to Remmy Pieters )

= 9.0.3 [20th November 2025] =

= Added =

* Ellipsis added in testimonial grid widget

= Fixed =

* Button URL issue fixed in Content Switcher widget
* Proper condition applied for content type controls in the content switcher widget
* Notice duplicate issue fixed

= 9.0.2 [14th November 2025] =

= Fixed =

* Animation fixed in shape builder extension

= Updated =

* Page Single Template (page|single) in Template Builder - Will be removed in v9.1.0 (Use standard page templates instead)

= 9.0.1 [11th November 2025] =

= Added =

* Shadow hide on & shadow width controls added in marquee widget
* Stack option added in Offcanvas widget

= Fixed =

* Liquid glass effect issue fixed
* Tags cloud always animate condition fixed
* Icon hover color issue fixed in timeline widget
* Button showing in Tooltip issue fixed in Advanced GMap widget ( Thanks to Jaco Hendriks  )
* Typography style conflict issue fixed in post content widget
* Primary Item Hide issue fixed in Post Grid * Alite Skin
* Filter "All" issue fixed in Post List and Post Gallery widget
* Smooth scroller conflict with offcanvas overlay, native scroll fixed ( Thanks to Md Abdullah Sakib )

= 9.0.0 [5th November 2025] =

= Added =

* Shape builder extension added
* Permission Manager feature added
* Custom Fonts upload feature added
* Custom Icons Library feature added
* Data source static feature added in tags cloud widget
* Marquee text with icon feature added in marquee widget
* Content direction space between option added in post list widget
* Rating (Above Text) feature added in testimonial grid widget
* Product template option now only shows when WooCommerce is active in Template Builder
* Accordion items controls added in accordion & faq widgets
* Icon link option added in post list widget
* Icon shape feature added in sub menu widget
* Content type price card added in content switcher widget
* Offcanvas overlay color added in mega menu & offcanvas widgets
* Switcher knob size added in content switcher widget
* Animation Type Always feature added in skin animated tags cloud widget

= Fixed =

* Icon position bottom responsive mode issue fixed in advanced icon box widget
* JS confliction with Zoloblocks fixed
* reCAPTCHA issue fixed in Simple Contact Form, User Login, User Register widget
* Sub title issue fixed in advanced heading widget
* SVG upload issue fixed in svg image widget
* Dynamic tag issue fixed in Thumb Gallery custom skin
* Pagination issue fixed in table skin in WooCommerce products widget
* SVG Draw Animation issue fixed in SVG Image widget
* Icon color issue fixed for custom content in timeline widget
* Offcanvas scrollbar issue fixed in mega menu widget
* Activ item for Static Menu issue fixed in Sub Menu widget ( Thanks to Nikolaos Koulouridis )
* Backdrop filter grid layout issue fixed
* Searchbox cross icon not showing issue fixed in floating knowledgebase widget
* Children Active menu issue fixed in Mega Menu widget ( Thanks to Nikolaos Koulouridis )

= 8.6.0 [22nd October 2025] =

= Added =

* Plugin Logo changing option added in White Label settings
* AJAX loading feature added to the Mega Menu for smoother content loading
* Integrated Google Sheet in Webhook Form widget
* Content style controls added in review card grid & carousel widgets
* Vertical direction (Top/Bottom) support added in Marquee widget
* Off-canvas added in mega menu widget
* Yoyo Effect control added in Animated Heading widget for split text animation repeat
* Border type and border radius controls added inside weather style section of the weather widget

= Fixed =

* Security: Privilege escalation vulnerability fixed in Setup Wizard template import endpoints
* Like/Comments spacing issue fixed in facebook feed and facebook feed carousel widgets
* Repeat animation issue fixed in Animated Heading widget
* Default Volume issue fixed in video player widget
* CSS file missing issue fixed in review card widget
* White Label information is now sent only to the licensed email address
* RTL issue fixed in Source Code widget
* Minimum height issue fixed in slideshow widget
* Navigation dots size issue fixed in editor mode
* SVG width issue fixed in advanced divider widget
* HTML tag validation issue fixed
* Elementor default tabs style confliction fixed

= Updated =

* Security improved
* Error handling updated in Template Library
* Style controls improved in fancy icons widget
...
* Elementor caching feature removed from Protected Content widget
