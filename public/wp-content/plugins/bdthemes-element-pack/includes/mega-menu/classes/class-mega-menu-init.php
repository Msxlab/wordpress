...
class Mega_Menu_Init {
	...
	public function ep_megamenu_includes_files() {
		...
		// Include the Handler API base class
		include_once BDTEP_PATH . 'base/handler-api.php';
		...
		include $this->dir . 'class-mega-menu-api.php';
	}
	...
	public function enqueue_scripts() {
		wp_enqueue_script('aesthetic-icon-picker', BDTEP_ADMIN_URL . 'assets/vendor/aesthetic-icon-picker/js/aesthetic-icon-picker.js', ['jquery'], BDTEP_VER, true);
