    ...
    <div class="bdt-modal-dialog bdt-ep-megamenu-modal-wrapper">
        ...
        <div class="bdt-modal-body">
            ...
            <div id="ep-megamenu-toggler">
                ...
                <a id="ep-content-trigger" class="elementor bdt-button bdt-button-default bdt-margin-small-right" href="javascript:void(0) "><?php echo esc_html__('Edit Dropdown Content', 'bdthemes-element-pack'); ?></a>
            </div>
            ...
            <!-- Ajax Loading Configuration -->
            <div id="ep-megamenu-ajax-toggler" class="ep-ajax-loading-section">
                <div class="ep-dashboard-widgets">
                    <label for="ep-ajax-loading-enable" class="ep-control-label">
                        <?php esc_html_e('Enable Ajax Loading', 'bdthemes-element-pack'); ?>
                    </label>
                    <input id="ep-ajax-loading-enable" type="checkbox" class="ep-item-toggle ep-ajax-toggle" value="1" data-feature="ajax-loading">
                </div>
            </div>
            <br></br>
            ...
            <div class="icon-picker-wrap" id="icon-picker-wrap">
                ...
                <div class="ep-icon-color">
                    <label for="ep-icon-color">
                        <?php esc_html_e('Choose Icon Color', 'bdthemes-element-pack'); ?>
                    </label>
                    <div class="form-control">
