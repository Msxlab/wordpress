	...
	public static function get_widget_settings($callable) {
		...
		$settings_fields = [
			...
			'element_pack_api_settings'     => [
				...
				[
					'name'  => 'google_sheets_group_start',
					'label' => esc_html__('Google Sheets Access', 'bdthemes-element-pack'),
					'desc'  => __('Configure Google Sheets API settings for webhook form integration. <a class="bdt-text-warning" href="https://bdthemes.com/knowledge-base/element-pack-pro-google-sheet-integration/" target="_blank">Documentation</a>', 'bdthemes-element-pack'),
					'type'  => 'start_group',
				],

				[
					'name'              => 'google_sheets_client_id',
					'label'             => esc_html__('Client ID', 'bdthemes-element-pack'),
				...
				[
					...
					'label'             => esc_html__('Client Secret', 'bdthemes-element-pack'),
				...
				[
					'name'  => 'google_oauth_connection',
					'label' => esc_html__('Google Account Connection', 'bdthemes-element-pack'),
					'type'  => 'html',
					'desc'  => self::get_google_oauth_connection_html()
				],

				[
					'name' => 'google_sheets_group_end',
					'type' => 'end_group',
				],
		...
		$settings_fields['element_pack_third_party_widget'][] = [
			...
			'widget_type'  => 'pro',
			'content_type' => 'post',
			'demo_url'     => 'https://www.elementpack.pro/demo/element/faq/',
